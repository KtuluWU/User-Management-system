        ...
        if ($request->isXmlHttpRequest()) {
            ...
            if (!empty($content)) {
                ...
                return new JsonResponse([
                    ...
                    'product_id' => $product_tracking->getProductId(),
                    'production_date' => $product_tracking->getProductionDate()->format('Y-m-d-H-i-s'),
                    ...
                    'milk_collection_time' => $product_tracking->getMilkCollectionTime()->format('Y-m-d-H-i-s'),
                    'ranch_responsible' => $product_tracking->getRanchResponsible(),
                    'factory' => $product_tracking->getFactory(),
                    'factory_processing_time' => $product_tracking->getFactoryProcessingTime()->format('Y-m-d-H-i-s'),
                    'factory_responsible' => $product_tracking->getFactoryResponsible(),
                    'factory_delivery_time' => $product_tracking->getFactoryDeliveryTime()->format('Y-m-d-H-i-s'),
                    'factory_delivery_responsible' => $product_tracking->getFactoryDeliveryResponsible(),
                    'export_time' => $product_tracking->getExportTime()->format('Y-m-d-H-i-s'),
                    'export_responsible' => $product_tracking->getExportResponsible(),
                    'import_time' => $product_tracking->getImportTime()->format('Y-m-d-H-i-s'),
                    'import_responsible' => $product_tracking->getArrivalResponsible(),
                    'center_arrival_time' => $product_tracking->getCenterArrivalTime()->format('Y-m-d-H-i-s'),
                    'arrival_responsible' => $product_tracking->getRanchResponsible(),
                    'site_1' => $product_tracking->getSite1(),
                    'site_1_delivery_time' => $product_tracking->getSite1DeliveryTime()->format('Y-m-d-H-i-s'),
                    'site_1_responsible' => $product_tracking->getSite1Responsible(),
                    'site_2' => $product_tracking->getSite2(),
                    'site_2_delivery_time' => $product_tracking->getSite2DeliveryTime()->format('Y-m-d-H-i-s'),
                    'site_2_responsible' => $product_tracking->getSite2Responsible(),
                    'site_3' => $product_tracking->getSite3(),
                    'site_3_delivery_time' => $product_tracking->getSite3DeliveryTime()->format('Y-m-d-H-i-s'),
